...
const Fotter = () => {
  return (
    <footer className="bg-black text-white py-8">
      <div className="flex container mx-auto px-8 md:px-16 lg:px-24">
        <div className="flex-1 flex-col mb:flex-row md:space-x-12 items-center mb-4">
          <div className="mb-4 md:mb-0">
            <h3 className="text-2xl font-bold mb-2">Amjad</h3>
            <p className="text-gray-400">
              Full Stack Based in the USA,specializing in web softwerdevloper
            </p>
          </div>
        </div>
